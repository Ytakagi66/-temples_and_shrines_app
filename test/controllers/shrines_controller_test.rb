...
class ShrinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shrine" do
    assert_difference('Shrine.count') do
      post shrines_url, params: { shrine: { adress: @shrine.adress, location: @shrine.location, name: @shrine.name, nearest_station: @shrine.nearest_station, photo: @shrine.photo, url: @shrine.url, user_id: @shrine.user_id } }
    end
  ...
  test "should update shrine" do
    patch shrine_url(@shrine), params: { shrine: { adress: @shrine.adress, location: @shrine.location, name: @shrine.name, nearest_station: @shrine.nearest_station, photo: @shrine.photo, url: @shrine.url, user_id: @shrine.user_id } }
