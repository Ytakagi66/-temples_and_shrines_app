...
class TemplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temple" do
    assert_difference('Temple.count') do
      post temples_url, params: { temple: { adress: @temple.adress, location: @temple.location, name: @temple.name, nearest_station: @temple.nearest_station, photo: @temple.photo, url: @temple.url, user_id: @temple.user_id } }
    end
  ...
  test "should update temple" do
    patch temple_url(@temple), params: { temple: { adress: @temple.adress, location: @temple.location, name: @temple.name, nearest_station: @temple.nearest_station, photo: @temple.photo, url: @temple.url, user_id: @temple.user_id } }
